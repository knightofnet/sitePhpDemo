 ...
 * Description :
 *      Cette page permet d'illuster comment fonctionne une page dédié à l'affichage d'un élément (ici une image,
...
if (isset($_GET['id']) ) {
    // Si oui, on récupère sa valeur, en testant qu'elle soit correcte, c'est-à-dire que ce soit bien en entier.
    // Si $_GET['id'] n'est pas un entier, $imageId = -1.
    $imageId=VerifierUtils::verifierEstEntier($_GET['id']);

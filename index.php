            ...
            <div class="card">
                ...
                <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#indexExplications">
                    <div class="card-body">
                        ...
                        <p>Le code source de ce site est disponible sur <a href="https://github.com/knightofnet/sitePhpDemo" target="_blank">GitHub</a>. Vous pouvez le télécharger, le modifier, l'utiliser comme bon vous semble. C'est un site de démonstration, il est là pour ça. La mise en place sur votre ordinateur est très simple : il suffit de télécharger le code source, de le décompresser, de le placer dans le répertoire de votre serveur web local (comme WAMP, XAMPP, etc.) et de lancer le serveur. Vous pourrez alors accéder au site en tapant l'URL de votre serveur web local dans votre navigateur. L'explication en détail de cette procédure se trouve ici : <a href="https://github.com/knightofnet/sitePhpDemo/blob/master/README.md" target="_blank">Lien vers le fichier README.md</a>
                        </p>
